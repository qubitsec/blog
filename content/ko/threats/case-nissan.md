...
다크웹에 게시된 사실을 공지했습니다. 닛산은 2024년 3월부터 약 **10만 명** 규모의 영향권 대상자에게 통지를 시작했습니다. :contentReference[oaicite:0]{index=0}
...
- **사건 발생일:** 닛산은 **2023년 12월 5일** 호주·뉴질랜드 IT 서버에 대한 무단 접근 사고를 확인했습니다. :contentReference[oaicite:1]{index=1}
- **피해 기업:** 닛산 오세아니아로, **Nissan Australia, Nissan New Zealand, Nissan Financial Services Australia, Nissan Financial Services New Zealand** 등이 포함됐습니다. :contentReference[oaicite:2]{index=2}
- **공격 주체:** 공식 공지에서는 공격자를 특정하지 않았지만, 보안 언론과 업계에서는 **Akira 랜섬웨어**의 소행으로 널리 보도됐습니다. :contentReference[oaicite:3]{index=3}
- **피해 규모:** 닛산은 약 **10만 명**이 영향을 받았다고 통지했고, NSW 정부도 같은 규모로 안내했습니다. :contentReference[oaicite:4]{index=4}
- **핵심 유출 데이터:** 이름, 연락처, 생년월일, 신분증 사본과 번호, 세금식별번호, 금융정보, 자동차 대출 정보, 고용정보 등 폭넓은 개인정보가 포함됐습니다. :contentReference[oaicite:5]{index=5}
- **중요 포인트:** 이 사건은 단순 제조업 침해가 아니라, **자동차 판매·정비·금융·보험 업무가 결합된 데이터 구조**가 한 번에 노출될 수 있다는 점에서 특히 위험합니다. :contentReference[oaicite:6]{index=6}
...
- 닛산은 **2023년 12월 5일**, 악성 제3자가 닛산의 호주·뉴질랜드 IT 서버에 **무단 접근**한 사이버 사고가 발생했다고 공식 공지했습니다. :contentReference[oaicite:7]{index=7}
- 닛산은 조사 결과, 일부 고객·직원·기타 이해관계자의 개인정보가 **탈취되어 다크웹에 게시**됐다고 밝혔습니다. :contentReference[oaicite:8]{index=8}
- 공지 대상은 닛산 브랜드만이 아니라, **Nissan Financial Services, Mitsubishi Motors Financial Services, Renault Financial Services, Infiniti Financial Services, Skyline Car Finance/Insurance** 등 관련 금융·보험 브랜드 이용자까지 포함될 수 있다고 안내했습니다. :contentReference[oaicite:9]{index=9}
- 닛산은 호주 및 뉴질랜드의 영향권 대상자에게 개별 통지를 시작했고, 일부는 연락처 부재 등으로 공지문을 통해 알렸습니다. :contentReference[oaicite:10]{index=10}

### 🟨 외부 보도 및 기관 안내로 확인되는 내용

- NSW 정부는 이번 사건 영향 규모를 약 **10만 명**으로 안내했습니다. :contentReference[oaicite:11]{index=11}
- NSW 정부 안내에 따르면 유출 데이터셋에는 약 **운전면허증 7,500건**, **메디케어 카드 4,000건**, **여권 220건**, **세금파일번호(TFN) 1,300건**이 포함됐고, 약 **10%**는 핵심 신분증 정보가 포함된 것으로 정리됐습니다. :contentReference[oaicite:12]{index=12}
- 보안 언론은 닛산 사건을 **Akira 랜섬웨어**와 연결해 보도했고, 공격자는 약 **100GB** 데이터 탈취를 주장한 것으로 알려졌습니다. 다만 이 수치는 해커 측 주장으로 봐야 합니다. :contentReference[oaicite:13]{index=13}

### 🗓️ 타임라인

- **2023-12-05:** 닛산 오세아니아 IT 서버 무단 접근 사고 발생 및 대응 개시 :contentReference[oaicite:14]{index=14}
- **2023-12월 중순:** 외부 보도 기준으로 Akira가 닷웹 유출 사이트에서 닛산 사건을 주장하고 공개 압박 시작 :contentReference[oaicite:15]{index=15}
- **2024-03-13:** 닛산이 조사 결과를 바탕으로 영향권 대상자 통지 개시 :contentReference[oaicite:16]{index=16}
- **2024-03-15 전후:** 호주 정부 기관과 언론이 약 10만 명 영향 사실을 공개 안내 :contentReference[oaicite:17]{index=17}
- **2024-04-15:** 닛산 대응 콜센터 운영사 OracleCMS에서 별도 데이터 유출이 발생해 일부 피해자 정보가 다시 노출되는 2차 사고가 발생했습니다. :contentReference[oaicite:18]{index=18}
...
단순 생산 차질이 아니라  
**금융사 수준의 개인정보 유출 사고**로 번질 수 있습니다. :contentReference[oaicite:19]{index=19}
...
즉, 이번 사건도 전형적인 **이중 협박(Double Extortion)** 구조로 해석할 수 있습니다. :contentReference[oaicite:20]{index=20}
...
**개인정보와 금융정보를 빼낸 뒤 공개를 압박하는 갈취형 랜섬웨어 운영**에 있습니다. :contentReference[oaicite:21]{index=21}
...
닛산은 공식 공지에서  
**어떤 취약점이나 계정이 최초 침투에 사용됐는지 공개하지 않았습니다.** :contentReference[oaicite:22]{index=22}
...
침해 후 자격증명 탈취와 추가 이동이 뒤따를 수 있다고 설명했습니다. FBI/CISA도 Akira가 2023년 3월 이후 광범위한 조직을 노렸다고 경고했습니다. :contentReference[oaicite:23]{index=23}

따라서 닛산 사건도  
정확한 경로는 미확정이지만,  
**외부 노출 원격접속 지점 또는 유효한 계정 악용 가능성**을 열어두고 보는 것이 합리적입니다. :contentReference[oaicite:24]{index=24}
...
모든 피해자에게 동일하게 적용되지는 않지만, 다음과 같은 정보가 포함될 수 있습니다. :contentReference[oaicite:25]{index=25}
...
즉, 단순 연락처 유출이 아니라  
**신원 도용, 금융사기, 세금 사기, 대출 사기, 표적 피싱**으로 직결될 수 있는 정보가 함께 노출된 사건입니다. :contentReference[oaicite:26]{index=26}
...
관련 금융·보험 서비스 이용 이력이 있다면 영향권일 수 있다고 설명했습니다. :contentReference[oaicite:27]{index=27}
...
즉, 이 사건은  
자동차 산업이 이미 **제조업 + 금융업 + 서비스업이 결합된 데이터 산업**이라는 점을 잘 보여줍니다. :contentReference[oaicite:28]{index=28}
...
기업과 중요 인프라 조직을 상대로 활동해 왔습니다. FBI/CISA는 Akira가 북미·유럽·호주 전반의 다양한 산업을 공격했다고 설명했습니다. :contentReference[oaicite:29]{index=29}
...
전형적 갈취형 랜섬웨어 운영 패턴의 일부로 볼 수 있습니다. :contentReference[oaicite:30]{index=30}
...
닛산이 제공한 일부 요약 정보가 다시 다크웹에 게시됐다고 공지했습니다. :contentReference[oaicite:31]{index=31}
...
닛산 사건은 이 점까지 보여준 드문 사례입니다. :contentReference[oaicite:32]{index=32}
