...
사고는 **피싱 이메일 + IT지원 사칭 전화(vishing)** 등 **소셜 엔지니어링**으로 직원 계정이 탈취되고, 이후 **고객 연락처/CRM 시스템에서 대량 조회·다운로드(스크래핑/수집)**가 발생한 것으로 보도되었습니다.  
...
## 사실 관계 정리 (무엇이 ‘확인’이고 무엇이 ‘보도’인가)

### ✅ Odido가 공개적으로 안내한 내용(확인)
...
> 포인트  
> 본 글은 “누가 했는가(Attribution)”보다, **어떻게 했는가(TTP)**를 중심으로 정리합니다.
...
> ✅ 포인트  
> 이 단계는 취약점(Exploit)보다 **신뢰(사람)와 절차(승인)**를 공격합니다.  
...
PLURA-EDR(문서 기준)은 다음 흐름을 제공합니다.
