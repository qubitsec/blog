...
**약 1.1TB 규모 데이터와 제조 도면 샘플**을 공개하며 협상을 압박한 정황이 확인됐습니다. :contentReference[oaicite:1]{index=1}
...
## 핵심 요약
- **공개 시점:** 에베레스트의 다크웹 유출 사이트 등록은 2026년 3월 6~7일경 공개적으로 포착됐습니다. :contentReference[oaicite:2]{index=2}
- **공격 주체:** 국제 랜섬웨어·데이터 갈취 조직 **에베레스트(Everest)** 입니다. 이 조직은 2020년 말부터 활동해 왔으며, 최근에는 암호화보다 **데이터 탈취 후 협박** 비중이 큰 것으로 알려져 있습니다. :contentReference[oaicite:3]{index=3}
- **유출 주장 규모:** 해커 측은 **1,116GB**, **115,282개 파일** 탈취를 주장했고, 일부 **2D 제조 도면** 샘플도 공개됐다고 보도됐습니다. :contentReference[oaicite:4]{index=4}
- **협박 방식:** 현대엘리베이터가 협상에 응하지 않으면 데이터를 외부에 공개하거나 판매하겠다는 **이중 협박(Double Extortion)** 방식입니다. :contentReference[oaicite:5]{index=5}
- **중요 포인트:** 현재 공개된 내용은 주로 **해커 측 주장과 이를 인용한 보도**를 중심으로 알려져 있으므로, 실제 침해 범위와 내부 피해 규모는 별도 조사 결과로 확정돼야 합니다. 다만 샘플 자료가 공개됐다는 점에서 실질적 침해 가능성은 높게 평가됩니다. :contentReference[oaicite:6]{index=6}
...
### ✅ 공개적으로 확인된 내용
- 랜섬웨어 그룹 **에베레스트(Everest)** 는 2026년 3월 7일경 자신들의 다크웹 유출 전용 사이트(DLS)에 현대엘리베이터를 피해 기업으로 등록했습니다. 일부 추적 사이트는 이를 3월 6일 발견으로 기록하고 있습니다. :contentReference[oaicite:7]{index=7}
- 보도에 따르면 해커 측은 현대엘리베이터 내부 자료로 보이는 샘플을 공개했고, 여기에 **2D 제조 도면**이 포함된 것으로 전해졌습니다. :contentReference[oaicite:8]{index=8}
- 안랩 ASEC도 2026년 3월 둘째 주 동향에서, 한국의 한 **엘리베이터 제조사**를 노린 에베레스트 공격 사례를 언급했습니다. :contentReference[oaicite:9]{index=9}
...
피해 기업 또는 수사기관이 공식 확정한 수치와는 구분해 볼 필요가 있습니다. :contentReference[oaicite:10]{index=10}

### 🗓️ 타임라인
- **2026-03-06 ~ 2026-03-07:** 현대엘리베이터가 에베레스트 유출 사이트 피해 기업 목록에 등장한 정황이 공개적으로 포착됨. :contentReference[oaicite:11]{index=11}
- **2026-03-07:** 국내 언론 보도로 사건이 본격적으로 알려짐. 해커 측은 2D 제조 도면을 포함한 내부 데이터 샘플을 공개했다고 전해짐. :contentReference[oaicite:12]{index=12}
- **2026-03-12:** 안랩 ASEC가 3월 둘째 주 다크웹·랜섬웨어 동향에서 한국 엘리베이터 제조사 대상 에베레스트 공격을 언급. :contentReference[oaicite:13]{index=13}
- **2026-03-16:** 해커 측이 표시한 협상 시한. :contentReference[oaicite:14]{index=14}
...
이번 현대엘리베이터 사례에서 **제조 도면**이 언급된 것도 이 때문입니다. :contentReference[oaicite:15]{index=15}
...
최근에는 **데이터를 먼저 빼내고, 이를 공개하겠다고 협박하는 방식**이 더 두드러집니다. :contentReference[oaicite:16]{index=16}
...
즉, 랜섬웨어라기보다  
**“데이터 탈취 + 공개 협박” 중심의 갈취 공격**으로 보는 것이 더 정확합니다. :contentReference[oaicite:17]{index=17}
...
보안 업계 추적 자료에 따르면 이들은 고객 데이터, 재무자료, 내부 문서, 데이터베이스 등 **기업 운영 핵심 데이터**를 탈취 대상으로 삼아 왔습니다. :contentReference[oaicite:19]{index=19}

최근 공개 보도 기준으로도 에베레스트는 다음과 같은 굵직한 피해 주장과 연결돼 왔습니다.
- **Under Armour** 관련 데이터 유출 주장 및 후속 데이터 공개 정황 :contentReference[oaicite:20]{index=20}
- **ASUS** 관련 1TB 이상 데이터 탈취 주장 :contentReference[oaicite:21]{index=21}
- **스웨덴 전력망 운영사 Svenska kraftnät** 대상 데이터 탈취 주장 :contentReference[oaicite:22]{index=22}

따라서 현대엘리베이터 사건도  
단발성 해프닝이 아니라,  
**제조·인프라·글로벌 기업을 상대로 반복돼 온 에베레스트식 갈취 운영의 연장선**에서 볼 필요가 있습니다. :contentReference[oaicite:23]{index=23}
...
이는 최소한 일부 내부 데이터가 외부로 반출됐을 가능성을 강하게 시사합니다. :contentReference[oaicite:24]{index=24}
