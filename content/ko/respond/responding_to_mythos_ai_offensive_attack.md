...
## 2. 정확한 표현은 CVE 10점대가 아니라 CVSS 10.0급입니다

여기서 용어를 하나 정확히 정리할 필요가 있습니다.

우리가 흔히 “CVE 10점대 취약점”이라고 말하지만,  
정확한 표현은 **CVSS 10.0급 취약점**입니다.

- **CVE**: 취약점 식별 번호
- **CVSS**: 취약점 심각도 점수

따라서 Mythos급 AI가 찾아낼 수 있는 가장 위험한 시나리오는  
“CVE 10점대”가 아니라  
**CVSS 10.0급 제로데이 취약점**입니다.

CVSS 10.0급 제로데이가 웹 서비스, 원격 접속 장비, VPN, 방화벽, 메일 서버에서 발견된다면  
그 순간 영화 속 제로데이 공격은 현실의 보안 사고가 될 수 있습니다.
