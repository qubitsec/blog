...
description: "쿠팡 개인정보 유출 제재에서 핵심은 과징금 액수만이 아니다. 확인된 사실, 기술적 추정, 확인 불가를 가르는 로그 기준이다. 웹 요청·응답 본문을 포함한 보호된 원본 로그와 보존 기준이 정리되어야 행정제재도 재발방지 기준으로 작동할 수 있다."
tags: ["쿠팡", "개인정보유출", "개인정보보호위원회", "과징금", "접속기록", "로그", "웹로그", "요청본문", "응답본문", "침해대응", "XDR", "PLURA-Blog"]
---

<!--
발행 전 확인 메모:
- 과징금 6,246억 8,100만 원, 과태료 1,680만 원, 약 3,755만 명 유출 결론은 개인정보보호위원회 2026-06-11 보도자료 기준입니다.
- 33,673,817건, 148,056,502회 조회, 실제 외부 전송 여부 확인 불가는 과학기술정보통신부 민관합동조사단 2026-02-11 정책브리핑 기준입니다.
- 접속기록 보관 의무 관련 고시는 국가법령정보센터의 「개인정보의 안전성 확보조치 기준」 [시행 2025.10.31.] 기준입니다.
- 실제 게시 직전에는 공식 보도자료의 첨부 PDF/HWP와 법령 링크 변경 여부를 다시 확인하는 것이 좋습니다.
-->
...
![쿠팡 사태와 로그 기준 쟁점 흐름](https://blog.plura.io/cdn/column/news-coupang-gov-briefing-log-gap-administrative-penalty-flow.png)
...
이 글의 핵심 수치는 2026년 6월 15일 기준으로 개인정보보호위원회 최종 제재 보도자료와 과학기술정보통신부 민관합동조사단 브리핑을 대조해 정리했다.[1][2]
...
[4]: https://www.pipc.go.kr/np/cop/bbs/selectBoardArticle.do?bbsId=BS074&mCode=C020010000&nttId=12173
