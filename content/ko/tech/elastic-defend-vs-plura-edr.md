...
시각화된 로그를 제공한다고 설명합니다. 이 구조는 PLURA-XDR로 확장될 때 WAF, SIEM, SOAR와 함께 웹 공격 대응까지 연결됩니다. 
...
즉,  
**웹은 더 이상 일부 서비스의 인터페이스가 아니라, 대부분의 업무와 운영, 보안 관리가 이루어지는 기본 접점**입니다. 이 점은 일반적인 업계 관찰이며, 위 기사도 웹 보안을 조직의 핵심 보안 과제로 다룹니다. 
