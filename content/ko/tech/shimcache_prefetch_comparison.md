...
> 목표: "침해 사고 분석(Incident Response)에서 가장 중요한 질문은 **'악성 파일이 실제로 실행되었는가?'**입니다. 공격자가 파일을 삭제하고 로그를 지워도, 윈도우는 흔적을 남깁니다. 본 글에서는 실행 흔적의 양대 산맥인 **ShimCache**와 **Prefetch**를 비교하고, 이를 통해 어떻게 사건의 재구성이 가능한지 현실적인 분석 방안을 제시합니다."
