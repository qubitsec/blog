...
참고: [맬웨어 감지 및 제거 관련 문제 해결 - Microsoft 지원](https://support.microsoft.com/ko-kr/defender/troubleshoot-problems-with-detecting-and-removing-malware)
...
참고: [Windows 보안으로 항목 검사 - Microsoft 지원](https://support.microsoft.com/ko-kr/windows/windows-%EB%B3%B4%EC%95%88%EC%9C%BC%EB%A1%9C-%ED%95%AD%EB%AA%A9-%EA%B2%80%EC%82%AC-d1c8c01d-12ed-e768-cbb8-830ea8ccf8e6)
...
참고: [제어된 폴더 액세스를 사용하여 중요한 폴더 보호 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/controlled-folder-access-overview)
...
참고: [PowerShell cmdlet을 사용하여 Microsoft Defender 바이러스 백신 구성 및 관리 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/use-powershell-cmdlets-microsoft-defender-antivirus)
...
참고: [PowerShell을 사용하여 Microsoft Defender 바이러스 백신 평가 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/microsoft-defender-antivirus-using-powershell)
...
Microsoft는 파일 확장명, 폴더 위치, 프로세스 기준으로 Defender 제외를 구성할 수 있다고 안내합니다. PowerShell에서는 위와 같이 `Add-MpPreference`를 사용해 필요한 항목만 제한적으로 추가합니다.

참고: [파일 확장명과 폴더 위치에 따라 제외 구성 및 유효성 검사 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/configure-extension-file-exclusions-microsoft-defender-antivirus)
...
참고: [Windows 보안 앱의 보호 기록 - Microsoft 지원](https://support.microsoft.com/ko-kr/windows/windows-%EB%B3%B4%EC%95%88-%EC%95%B1%EC%9D%98-%EB%B3%B4%ED%98%B8-%EA%B8%B0%EB%A1%9D-f1e5fd95-09b4-46d1-b8c7-1059a1e09708)
...
문제가 특정 파일, 폴더, 확장명, 프로세스에 한정된다면 전체 보호를 끄기보다 최소 범위의 제외 설정을 먼저 검토하는 것이 좋습니다.
...
- [맬웨어 감지 및 제거 관련 문제 해결 - Microsoft 지원](https://support.microsoft.com/ko-kr/defender/troubleshoot-problems-with-detecting-and-removing-malware)
...
- [PowerShell cmdlet을 사용하여 Microsoft Defender 바이러스 백신 구성 및 관리 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/use-powershell-cmdlets-microsoft-defender-antivirus)
...
- [PowerShell을 사용하여 Microsoft Defender 바이러스 백신 평가 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/microsoft-defender-antivirus-using-powershell)
- [제어된 폴더 액세스를 사용하여 중요한 폴더 보호 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/controlled-folder-access-overview)
- [파일 확장명과 폴더 위치에 따라 제외 구성 및 유효성 검사 - Microsoft Learn](https://learn.microsoft.com/ko-kr/defender-endpoint/configure-extension-file-exclusions-microsoft-defender-antivirus)
