...
그러나 웹 환경에서는 이 기대가 생각보다 쉽게 무너집니다. :contentReference[oaicite:1]{index=1}
...
> **최종 사용자 입장에서는 데이터가 결국 평문으로 보인다**는 점입니다. :contentReference[oaicite:2]{index=2}
...
원문에서도 이 점을 지적하며  
“브라우저의 요청으로 웹 서버의 데이터가 유출되는 것이므로, 어떤 데이터가 포함되는지 실시간 분석한다면 탐지가 가능하다”고 설명했습니다. :contentReference[oaicite:3]{index=3}
...
민감 정보를 탈취하는 사례를 보여줍니다. :contentReference[oaicite:4]{index=4}
