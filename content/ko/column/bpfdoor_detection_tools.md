...
| 항목 | 🛡 **KISA**
(공식 가이드 스크립트) | **PLURA-XDR** | **B사 탐지 프로그램** | **A사 탐지 프로그램** |
| --- | --- | --- | --- | --- |
| 1. 락파일 확인 | ✅ | ✅ | ❌ | ❌ |
| 2. 자동 실행 확인 | ✅ | ❌ | ❌ | ❌ |
| 3. BPF 필터 감지 | ✅ | ✅ | ❌ | ✅ |
...
| 솔루션 | 장점 👍 | 단점 ⚠️ |
| --- | --- | --- |
| 🛡️ **KISA 가이드** | ✅ 공신력 있는 공식 자료
✅ 다양한 탐지 항목 제공 | ❌ 실시간 탐지 불가
❌ 수동 점검 필요 |
| 🔐 **PLURA-XDR** | ✅ 실시간 탐지 및 자동 대응
✅ eBPF 악용 공격도 탐지 가능 | ❌ 에이전트 설치 필요
 |
| 🧰 **A사** | ✅ 많은 해시 값으로 다양한 파일 탐지
✅ 악성파일 자동 삭제 가능 | ❌ 탐지 항목 제한
❌ 변종 탐지 한계 |
| 🧪 **B사** | ✅ 다양한 탐지 항목 제공 
✅ 포렌식 자료 수집에 유용 | ❌ 전문가의 점검 필요
❌ 광범위한 탐지로 부하 고려 필요 |
