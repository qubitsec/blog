...
아래는 **“로그 수집부터 불가능한 현실”**(웹 서버 로그 수집 한계, 감사 정책 한계)와
\*\*“IPS, NDR, WAF, EDR 로그 수집 한계”\*\*를 한 문서에 **통합**한 버전입니다.
문서 흐름이 자연스럽도록, 먼저 **기초 로그 수집 한계**(웹 서버, 운영체제 감사) →
**정보보안 제품별 로그 한계**(IPS, NDR, WAF, EDR) 순서로 배치했으며,
마지막에 **최종 요약**으로 마무리했습니다.
