...
| **Sekoia Rule Catalog**  | “SentinelOne 환경에서 msiexec.exe 사용 시 권한 상승 가능” ([Sekoia 문서][2])                    |
| **Aon CyberLabs 분석 보고서** | Babuk 랜섬웨어가 SentinelOne anti-tamper 우회 후 실행됨, EventID 1·93에 로그 확인 ([Aon 보고서][3]) |
