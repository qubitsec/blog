...
여기에 한국 금융권의 **마이데이터 사업**도 함께 떠올릴 필요가 있습니다.

마이데이터 역시  
“데이터를 더 많이 연결하면 더 좋은 금융 서비스가 열린다”는 기대 속에서  
모든 금융기관이 뛰어들고, 수많은 스타트업도 참여했습니다.  
실제로 제도 확산 규모는 매우 컸고, 2025년 5월 말 기준 이용자 수는 약 **1억 6,531만 명**, 14세 이상 국민 1인당 평균 **3.5개 서비스** 이용 수준까지 확대됐습니다.  
하지만 업계에서는 API 호출 과금 구조 때문에 **사용자가 늘수록 적자가 커지는 구조**가 문제로 지적됐고, 사업 철수 사례도 나왔습니다. :contentReference[oaicite:0]{index=0}
