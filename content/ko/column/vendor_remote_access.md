...
|  8 | 관리 포털 API **비정상 메서드** 호출       | unusual HTTP methods, 과다 4xx/5xx, rate spike | API 키 폐기·회전, WAF/Rate Limit 강화, 소스 IP 차단 |
...
* **서드파티 자격증명/단말 = 초기 침입의 지름길**  
  농협(2011)처럼 **협력사 단말 경로**가 전산 마비로 이어질 수 있고, SolarWinds(2020)처럼 **서드파티 관리 채널**이 조직 전반의 **측면이동 발판**이 됩니다. *(근거: Korea Times 보도, CISA ED-21-01)*
