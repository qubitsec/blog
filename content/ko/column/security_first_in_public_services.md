...
또 CISA는 클라우드·SaaS 서비스에서 **MFA, SSO, 보안 로그 제공**을 기본 제공 기능으로 강조합니다. :contentReference[oaicite:2]{index=2}
...
CSA의 Cloud Controls Matrix는 클라우드 보안 평가에 사용할 수 있는 대표 프레임워크이며, 최신 Security Guidance v5는 IAM, 데이터 보안, 로깅, 공급망, 제로 트러스트를 핵심 영역으로 다룹니다. :contentReference[oaicite:3]{index=3}
...
CISA는 클라우드 서비스가 **보안 관련 로그를 추가 비용 없이 생성·저장·제공**해야 한다고 강조합니다. :contentReference[oaicite:4]{index=4}
...
NIST는 제로 트러스트를 사용자, 자산, 리소스 중심의 접근제어 패러다임으로 설명합니다. 퍼블릭 서비스 평가에서도 이 기준이 중요합니다. :contentReference[oaicite:5]{index=5}
...
* NIST Zero Trust Architecture (SP 800-207) :contentReference[oaicite:6]{index=6}
* CISA Secure by Design / Secure by Demand 가이드 :contentReference[oaicite:7]{index=7}
* CSA Security Guidance v5 / Cloud Controls Matrix :contentReference[oaicite:8]{index=8}
