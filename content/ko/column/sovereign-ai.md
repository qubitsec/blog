...
* [ ] TLS 종료 지점에서 POST 본문 캡처 시작
* [ ] 고위험 URI 전량 수집
* [ ] Windows Process Creation + Sysmon 최소 이벤트 적용
* [ ] Linux auditd `execve` + 웹루트 쓰기 감시 적용
* [ ] PII 마스킹 프로파일 1차 적용
* [ ] 스키마와 `trace_id` 통일
...
* [ ] 샘플링 → 전문 수집 전환 로직 구현
* [ ] 성능 가드레일 적용
* [ ] 웹 이벤트와 호스트 이벤트 조인 품질 점검

### D+90: AI 준비도 달성

* [ ] 웹 → 호스트 → 계정 → 네트워크 스토리라인 재구성
* [ ] LLM 기반 triage 보조 적용
* [ ] 격리, 계정 잠금, 티켓 발행 플레이북 연결
* [ ] QoD KPI 운영
