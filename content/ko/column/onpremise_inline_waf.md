...
- **`벤더 주의`**: 일부 제품은 요청 바디 **64KB**(리소스 유형에 따라 기본 8–16KB, 최대 64KB)까지만 검사하고, **상한 초과 시 `Oversize handling = Continue`(부분 우회/bypass)** 로 동작하도록 설정할 수 있습니다. 이 경우 상한을 넘는 구간에 숨겨진 페이로드가 **검사를 우회**할 수 있습니다. 
