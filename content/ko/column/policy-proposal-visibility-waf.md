...
# 6) 특허 리스크: 본 아키텍처는 당사 보유 특허 권리 범위에 포함될 수 있음 (검토 필수)

> 아래 내용은 법률 자문이 아니며,
> 특허 권리 범위 해석은 전문 변리사·법률 자문을 통해 확정되어야 합니다.

교육부가 추진하는 본 사업의 핵심 구조는 다음과 같습니다.

* 방화벽·WAF 차단 이후 구간에서의 정밀 분석
* 웹 요청(Request) 및 응답(Response) 본문 기반 분석
* 실시간 위협 탐지 및 자동 대응 연계
* 중앙 관제 체계와의 연동 구조

이와 같은 구조는
**큐비트시큐리티가 국내 및 해외에 등록·보유 중인 특허 기술의 권리 범위와 중첩될 가능성이 존재합니다.**

특히,

* 웹 트래픽의 본문(Post-body) 분석 기반 위협 탐지
* 차단 이후 내부 유입 트래픽에 대한 정밀 분석 구조
* 실시간 탐지와 자동 대응 연계 체계
* 중앙 집중형 분석·통제 구조

등은 당사가 기술적 독창성을 인정받아 등록한 특허 포트폴리오의 핵심 영역입니다.

---

## 6-1. 왜 사전 검토가 필요한가

정책 표준 아키텍처에 해당 구조가 명시될 경우,

1. 향후 유사 구조를 구현하는 사업자가
   특허 침해 소지를 갖게 될 수 있으며,
2. 조달 이후 권리 분쟁이 발생할 경우
   사업 지연·추가 비용·운영 중단 위험이 발생할 수 있습니다.

따라서 본 사업은 단순 기술 검토가 아니라
**지식재산(IP) 관점의 사전 검토가 병행되어야 합니다.**

---

## 6-2. 정책·조달 단계에서의 권고 사항

1. **특허 권리 범위 검토(FTO) 의무화**

   * 본 사업 아키텍처가 당사 특허 권리 범위에 포함되는지 사전 검토

2. **특허 라이선스 협의 절차 명문화**

   * 권리 범위에 포함될 경우 정식 라이선스 계약 체결

3. **RFP에 IP 책임 조항 명시**

   * 납품사는 제3자 권리 침해 여부에 대한 보증 제공
   * 침해 발생 시 방어·대체·손해배상 책임 명확화

4. **설계 대안 검토**

   * 특허 회피(Design-around) 구조가 가능한 경우 기술적 대안 검토

---

## 6-3. 정책적 의미

본 제안은 특정 기업을 배제하기 위한 목적이 아니라,

* 기술적 독창성이 이미 특허로 보호되고 있는 영역을
  국가 사업에서 무심코 침해하지 않도록 예방하고,
* 향후 분쟁 없이 안정적으로 운영 가능한 체계를 마련하기 위한
  **사전 리스크 관리 차원의 제안**입니다.

국가 단위 사업일수록
기술 검토와 함께 **지식재산 검토가 필수 요소**가 되어야 합니다.
...
| 기존 표현           | 수정 방향                  |
| --------------- | ---------------------- |
| 제3자 특허와 충돌 가능성  | 당사 보유 특허 권리 범위 포함 가능성  |
| 벤더가 침해 주장할 수 있음 | 당사가 권리자로서 보유 중         |
| 분쟁 위험 일반론       | 국가 사업 IP 리스크 관리 필요성 강조 |
