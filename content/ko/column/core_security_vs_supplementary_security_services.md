...
이 핵심적인 목적인 ‘공격 탐지 및 대응’을 효과적으로 달성하기 위해서, 정보보안의 **핵심**(Core)이 되는 요소들은 아래 네 가지로 요약될 수 있습니다.
...
## 보안팀 역량의 분산: “부가 서비스”가 가져오는 현실적인 문제

문제는, 실제 **보안팀 담당자**가 위에서 언급한 코어 보안(사전 점검, WAF 운영, 침해탐지/대응, 모니터링)보다 **부가 서비스** 지원에 훨씬 많은 시간을 할애하고 있다는 점입니다.
기업 내부 사정에 따라 차이는 있지만, 많은 보안팀에서 **업무의 70~90**%를 계정 관리, 권한 설정, 규정 준수 작업, 각종 요구사항 처리 등 “**부가적 운영 업무**”에 투입하고 있습니다.

이로 인해 정작 **침해 사고 대응 역량 강화**, **위협 인텔리전스 분석**, **보안 솔루션 간 연동 및 최적화** 등 **핵심 업무**에는 **10~30**%의 시간밖에 배정하지 못하게 됩니다.
결국 “보안을 위한 팀”이 본연의 보안 업무에 집중하지 못하고, **서버 권한 요청이나 감사 로그 정리 같은 행정성 작업**에 매몰되는 악순환이 벌어지고 있는 셈입니다.

이런 현상이 지속되면, 조직의 보안 수준은 물론이고 보안팀의 전문성·사기저하 문제까지 야기할 수 있습니다.

### IT 관리 부서로 부가서비스를 이관하는 방안

* **부가서비스**(계정 관리, 일부 모니터링/로그 정리, 장비 운영 지원 등) 중 상당 부분은 **반드시 보안팀이 직접 수행할 필요가 없는** 경우도 많습니다.
* 예를 들어, 권한 요청·해지 프로세스나 기기 관리 업무는 **IT 관리 부서**(헬프데스크, 인프라 운영팀 등)에서 처리해도 보안 정책과 충돌이 없도록 사전에 정의·교육만 잘하면 충분히 가능할 수 있습니다.

> **핵심 아이디어**:
>
> 1. **보안팀**은 **정책 수립, 통제 규칙 정의, 핵심 침해사고 대응**에 집중
> 2. **IT 관리 부서**는 보안팀의 정책을 기반으로 **부가서비스**를 실행 및 운영
> 3. 필요한 경우 **정기 리뷰**와 **감사** 과정을 통해 보안팀이 제대로 된 통제를 하고 있는지 확인

이를 통해 보안팀은 본연의 **코어 업무**(공격 탐지·대응, 취약점 관리)에 더 많은 시간을 할애할 수 있고, IT지원 부서는 이미 갖추고 있는 사용자 지원 및 시스템 운영 역량을 활용하여 부가업무를 효율적으로 처리할 수 있습니다.

---

## 결론: 정보보안의 핵심에 집중하되, 부가적 업무는 효율적으로 분배하자
...
문제는 **보안팀이 부가 서비스 업무를 전부 떠안으면서 정작 코어 업무에는 10~30%만 집중하게 되는 현실**입니다.
이를 극복하기 위해서는, **정책 및 핵심 통제 권한은 보안팀이 유지**하되, **단순·반복적이고 운영적인 업무**는 **IT 관리 부서**로 이관하는 모델을 검토해야 합니다.

* **과도한 솔루션 도입으로 인한 예산·운영 리스크**를 줄이고,
* **코어 보안 역량(침해사고 대응, 위협 분석 등)을 강화**하며,
* **필요 시 IT 관리 부서와 협력**하여 운영 효율을 높여야 합니다.
...
> * **부가서비스 처리 로드**가 큰 경우, 헬프데스크나 인프라 운영팀에 역할을 분담하여 **보안팀의 시간을 확보**합니다.
> * 기술 투자뿐 아니라 **인력 역량 강화**(보안 인식 교육, 전문 인력 양성)도 병행해야 보안 효과가 극대화됩니다.

---

**결론적으로, 정보보안에서는 ‘탐지 및 대응’이 무엇보다 핵심**입니다.
부가적인 운영 요소들을 적극적으로 활용하되, “보안팀이 해야 할 일”과 “IT 관리 부서가 담당해도 되는 일”을 분명히 구분해서 조직 내 **보안 역량**을 최적화하는 전략이 중요합니다.
궁극적으로 **해킹 방어와 신속 대응**에 더욱 집중할 수 있는 구조를 마련하는 것이, 진정한 **보안 강화**의 첫걸음입니다.
