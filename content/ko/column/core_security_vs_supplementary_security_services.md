...
> **Note**  
> 과거에는 “4) 지속적 시스템 모니터링”을 코어로 분류한 경우도 있으나,  
> 일반적으로 **시스템 자원 및 성능 모니터링**은 **운영팀**이 담당할 때가 많고,  
> **실시간 침해 탐지**의 핵심 범주에서 다소 벗어난다고 볼 수 있습니다.  
> 따라서 본 글에서는 **운영형 보안(부가 요소)**로 분류합니다.
...
> **결론적으로**, 이 목록에 나열된 서비스들은 **모두 보안에 중요한 역할**을 하지만,  
...
- **핵심 보안(코어)**: 위에서 언급한 **사전 취약점 점검, 예방(WAF), 탐지/대응(EDR·XDR)**  
...
계정관리(IAM/PAM)나 데이터 보호(DLP, DRM) 등은 **기업 전체 보안을 유지**하는 일정한 역할을 합니다.
