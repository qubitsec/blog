...
계정관리(IAM/PAM)나 데이터 보호(DLP, DRM) 등은 **기업 전체 보안을 유지하는 중요한 역할**을 합니다.
...
>  
> 따라서 **보안팀 본연의 임무**(침해 대응, 위협 분석, 취약점 관리 등)를 **집중**할 수 있도록,  
> 이들 **부가적 서비스**는 **IT 관리 부서**나 **헬프데스크**와 **협업**하는 방식으로 운영하는 것이 효율적입니다.
