...
## 🕵️‍♂️ 캠페인: PLURA-XDR을 활용한 공급망 보안 강화 방안 [1탄]
...
4) **실제 공급망 해킹 공격 사례**  
   - **혼다(Honda) 해킹(2020년)**: 혼다가 전 세계적으로 운영 중인 일부 공장과 생산 라인이 사이버 공격을 받아 가동을 일시 중단해야 했습니다. 이로 인해 차량 생산뿐만 아니라 협력사와의 부품 수급, 물류에도 연쇄적인 차질이 발생하였습니다.  
   - **SolarWinds 해킹(2020년)**: IT 관리·모니터링 소프트웨어를 제공하는 미국의 SolarWinds가 해킹되어 업데이트 파일이 악성코드로 감염되었습니다. 이를 이용해 전 세계 수많은 기업과 정부 기관에 침투함으로써 광범위한 피해가 발생했으며, 공급망 공격의 대표 사례로 꼽힙니다.
   - **Kaseya 랜섬웨어 공격(2021년)**: IT 관리 소프트웨어 기업 Kaseya를 타깃으로 한 공급망 공격으로, 협력사 및 고객사에 연쇄적으로 악성코드가 확산되었습니다. 이를 통해 여러 중소·중견 기업이 큰 피해를 입었습니다.  
   - **도요타(Toyota) 공급망 공격(2022년)**: 주요 부품 협력사인 ‘고지마 인더스트리(Kojima Industries)’가 사이버 공격을 받아, 도요타는 일본 내 모든 공장의 생산을 하루 동안 중단해야 했습니다. 이는 단 하루의 중단이었지만, 글로벌 완성차 기업에 있어 공급망 보안 문제가 곧 대규모 생산 차질로 이어질 수 있음을 단적으로 보여준 사례입니다.

이러한 사례들은 협력사나 IT 관리 업체 등 ‘공급망의 약한 고리’를 공략함으로써 전체 공급망에 심각한 타격을 줄 수 있음을 잘 보여줍니다.
...
2) **XDR 플랫폼의 통합성**  
   ...
   - 다양한 기능(WAF, EDR, Forensic, SMS, SIEM 등)을 한 플랫폼에서 제공해, 솔루션 간 호환성과 운영 편의성이 탁월합니다.
