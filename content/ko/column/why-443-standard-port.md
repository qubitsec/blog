...
# [정책제안] 공공 웹사이트는 왜 기본 포트(80, 443)를 써야 하나

> **요약 한 줄**  
> **대국민 서비스는 443(HTTPS) 고정 + 80→443 리다이렉트**가 표준입니다.  
> 비표준 포트(예: 8080, 8443)로 대외 공개하면 **접근성·규정준수·보안운영·성능**이 연쇄적으로 깨지고, **민원·협력기관의 아웃바운드 방화벽 개방**을 유발해 **공격면을 폭발적으로 확대**합니다.
