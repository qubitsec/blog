...
date: 2026-04-19
draft: false
description: "병원 용어도, 무역 용어도, 양자역학도, 사이버보안도 처음에는 낯설고 어렵다. 모든 분야를 다 이해할 수는 없다. 그래서 더 중요한 것은 많이 아는 것이 아니라, 복잡한 분야를 어떤 방식으로 이해할 것인가이다. 유추가 아니라 원리에서 출발하는 제1원리 사고는 그 출발점이 될 수 있으며, AI 해킹 시대에는 무엇을 봐야 하는가와 같은 AI 해킹 대응의 관점에서도 더욱 중요해진다."
