...
최근 수년간 발생한 국내외 침해 사고를 보면, **많은 대규모 침해 사고에서 SSL VPN 장비가 초기 진입점으로 활용**되고 있습니다. 특히 Ivanti Connect Secure/Policy Secure와 Fortinet FortiOS SSL VPN 계열은 CISA·IPA가 별도 경보를 낼 정도로 반복적인 취약점 이슈가 이어졌습니다. 
...
👉 보안 업계에서는 **VPN 장비가 주요 초기 진입 경로 중 하나**라는 점이 더 이상 낯선 이야기가 아닙니다. 특히 Ivanti와 Fortinet 계열 취약점은 2024~2025년에도 공식 기관이 적극 경고했습니다. 
...
**사용자·자산·리소스 중심으로 매 요청을 검증하는 구조**로 설명합니다. 
