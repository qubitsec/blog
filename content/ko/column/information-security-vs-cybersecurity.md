...
건축은 전체 공간의 큰 그림을 설계하지만, 조경은 조경만의 언어와 판단 기준이 있습니다.  
조경은 단순한 장식이 아니라 배수, 동선, 식재, 유지관리까지 포함하는 독립된 전문 영역입니다.

사이버보안도 그렇습니다.  
정보보안은 조직의 보안 관리체계라는 큰 틀을 만들지만,  
사이버보안은 공격자의 침투 경로, 로그 흐름, 실시간 탐지와 차단을 다루는 별도의 전문 영역입니다.
...
| 구분 | 정보보안 관점의 컴플라이언스 | 사이버보안 관점의 침해대응 |
|---|---|---|
| 대표 체계 | ISMS-P | 침해 탐지·분석·대응 체계 |
| 핵심 목적 | 정보보호·개인정보보호 관리체계 수립 | 실제 공격의 조기 탐지와 피해 확산 차단 |
| 주요 질문 | 정책과 절차가 있는가? | 공격이 지금 발생하고 있는가? |
| 로그 관점 | 수집·보관·점검·증적 | 실시간 분석·상관분석·공격 흐름 재구성 |
| 방화벽·웹방화벽 관점 | 운영 여부와 정책 관리 | 공격 요청, 계정 행위, 서버 이벤트 연결 분석 |
| 책임 방식 | 관리체계 운영 책임 | 침해 예방·탐지·대응 실패에 대한 운영 책임 |
| 성격 | 정보보안 자율 관리 체계 | 사이버보안 자율 대응 체계 |
...
SAST는 배포 전 소스코드 취약점을 찾습니다.  
SBOM은 소프트웨어 구성요소를 식별합니다.  
...
SAST가 있다고 해서  
운영 중인 웹 요청의 공격 페이로드를 실시간으로 차단할 수 있는 것은 아닙니다.

SBOM이 있다고 해서  
공격자가 취약한 구성요소를 실제로 악용하는 순간을 탐지할 수 있는 것은 아닙니다.

ISMS-P 인증을 받았다고 해서  
공격자의 침투 흐름이 실시간으로 상관분석되는 것은 아닙니다.
