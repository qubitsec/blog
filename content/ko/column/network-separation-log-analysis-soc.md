...
- 로그를 저장하는 것만으로는 부족하며, 이상 징후를 판별하고 대응하는 **SOC(Security Operations Center)** 가 필요합니다
...
네트워크 정책상 PLURA 로그 전송이 현재 불가능하다면  
견적이나 적용 범위에서 서버 호스트보안과 SOC를 제외할 수는 있습니다.

그러나 그 의미를 다음과 같이 정확히 구분해야 합니다.
