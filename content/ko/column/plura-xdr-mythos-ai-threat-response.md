...
tags: ["ISMS-P", "정책제안", "정보보안인증", "보안정책", "공격대응", "로그분석", "Mythos", "AI 보안"]
---
...
**공격 탐색 속도와 변형 속도가 빨라지고, 방어자의 대응 시간이 더 짧아진다**는 점에 있습니다.
...
왜냐하면 Mythos 같은 AI 기반 공격은 다음과 같은 특징을 갖기 때문입니다.

- 알려진 패턴이 아니라 새로운 변형으로 들어올 수 있고
- 요청 하나만이 아니라 응답 결과와 후속 서버 행위까지 함께 봐야 하며
- 웹, 계정, 서버, 데이터 유출 흐름을 하나로 연결해 해석해야 하고
- 몇 시간 뒤 분석이 아니라 몇 분 안의 탐지와 차단이 중요하기 때문입니다
...
- 부분 로그가 아니라 full 로그 기반으로 어떤 흐름을 재구성할 것인가
