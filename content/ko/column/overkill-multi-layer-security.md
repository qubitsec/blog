...
또한, 이 문제를 해결한다고 에이전트리스(Agentless)로 구축하면, 아무것도 할 수 없는 결론에 도달하게 됩니다.  
...
* 강이나 바다에 추락하는 상황에서도 나올 수 있는 수륙양용차를 만들게 됩니다.
* 총격·포탄에 대비한 자동차 심지어 핵전쟁에 대비하여 방사능을 제거하는 기능을 탑재할 수 도 있습니다.
* **발생 가능성이 매우 희박한 상황**까지 모두 대비하려 하면,
