...
* **핵심 제안:**
  ...
  1. **ISMS-P 강화 일변도 정책 재검토**
  2. 인증 중심 → **보안 가이드·성과 중심 체계 전환**
  3. 징벌적 과징금은 **최소 기준 미이행·중과실·반복 위반에 한정**
  4. 보안 담당자 **업무 지속성과 인력 보호를 정책 목표에 포함**
...
* 정부는 **Zero Trust Architecture** 등  
  **참조 보안 아키텍처와 최소 보안 기준**(Baseline)을 제시
