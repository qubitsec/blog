...
AI에게도 마찬가지다. AI가 공격의 맥락을 설명하려면 최상의 데이터, 즉 실제 행위와 의미를 담은 데이터가 제공되어야 한다. payload, 로그, 계정 행위, 프로세스 실행, 파일 접근 기록 없이 패킷 크기·방향·순서·간격 같은 외형 정보만 제공하고 공격의 맥락을 설명하라고 하는 것은 기술이 아니라 마술에 가깝다.
