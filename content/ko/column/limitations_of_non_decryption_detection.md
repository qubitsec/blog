...
1. 무엇을 보는가? → **메타데이터만인지, 실제 내용까지라는 주장인지**
2. TLS 1.3, QUIC에서도 동작하는가?
3. 탐지율 수치의 **검증 프로토콜**은 무엇인가?
4. 제3자 검증(PoC, 인증 시험)이 존재하는가?
5. 단순 우회(패딩, JA3 위장)에 견딜 수 있는가?
6. 성능/지연/스케일링 데이터는 실측했는가?
7. 개인정보 보호·통신비밀 규제 이슈는 없는가?
8. 모델 학습·검정은 어떻게 관리되는가?
